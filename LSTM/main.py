...
def main():
    ...
    X_train_val, X_test, y_train_val, y_test = train_test_split(X_activity, y, test_size=0.2, random_state=50)
    ...
    lstm.fit(X_activity_train, met_train, y_train, X_activity_val, met_val, y_val, X_activity_test, met_test, y_test)
